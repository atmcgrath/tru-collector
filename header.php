		...
		<div class="sidebar">
			...
			<?php endif; ?>
				...
				<div class="credits">
					...
					<p>Theme: <a href="https://github.com/cogdog/tru-collector">TRU Collector</a>, a SPLOT by <a href="https://cog.dog">@cogdog</a> (<?php _e('based on Fukasawa  by ','fukasawa'); ?> <a href="http://www.andersnoren.se">Anders Nor&eacute;n</a>).</p>
				</div><!-- .credits -->
